...
COMMANDS: List[MenuItem] = [
    ...
    MenuItem("/dashboard", "/dashboard", "Launch or view the real-time Live Web Sidecar Dashboard"),
    MenuItem("/swarm", "/swarm", "Launch multi-agent autonomous swarm (Architect + Coder + Reviewer)"),
